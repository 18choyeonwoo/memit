// src/api/mockData.js
// original data.js contents migrated here to act as a mock database
...
export const leaderboardItems = [
  { rank: '01', title: '오빠 나 어떻해..', tags: '#슈게임 #감정 #격정', trend: 'up', likes: '12k' },
  { rank: '02', title: '배우고 갑니다', tags: '#감에 #배우신분', trend: 'up', likes: '8.5k' },
  { rank: '03', title: '손님 배로 테이블 치지...', tags: '#웹툰 #프리드로우', trend: 'same', likes: '5.2k' },
  { rank: '04', title: "I'm fine", tags: '#아임피네 #감정 #괜찮아', trend: 'up', likes: '3.1k' },
  { rank: '05', title: '팔리아치', tags: '#삐에로 #힘스', trend: 'down', likes: '1.2k' },
];
